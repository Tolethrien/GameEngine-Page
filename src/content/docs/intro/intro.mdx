...
<br />
Gotowość Modułów dla wersji: **0.01A**
<br />

- <Progress name="Editor" percent={10} status="Preplaning" />
- <Progress name="Core" percent={75} status="In progress" />
- <Progress name="Aurora" percent={80} status="In progress" />
- <Progress name="Dogma" percent={90} status="In progress" />
- <Progress name="MapCreator" percent={0} status="Preplaning" />
- <Progress name="FontParser" percent={25} status="On hold" />
- <Progress name="NaviGPU" percent={40} status="In progress" />

...
<br />
Gotowość Modułów dla wersji: **{stats.currentVersion}**

<br />

- <Status name="Editor" percent={10} status="Preplaning" />
- <Status name="Core" percent={75} status="In progress" />
- <Status name="Aurora" percent={80} status="In progress" />
- <Status name="Dogma" percent={90} status="In progress" />
- <Status name="MapCreator" percent={0} status="Preplaning" />
- <Status name="FontParser" percent={25} status="On hold" />
- <Status name="NaviGPU" percent={40} status="In progress" />
